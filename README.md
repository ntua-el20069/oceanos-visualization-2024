...
2. Write in bash console in Python (if there is open console, do not open new!) `cd /home/oceanosntua/`
...
8. In your <strong>local</strong> `useful.py`, set `console_id` to the id of the console you opened above
